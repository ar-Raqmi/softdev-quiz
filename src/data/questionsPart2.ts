export const questionsPart2 = [
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "A Form and a drop-down list named gender with two options"
      },
      {
        "id": "B",
        "text": "Two (2) check boxes and a Submit button"
      },
      {
        "id": "C",
        "text": "A Form and (2) radio buttons named gender"
      },
      {
        "id": "D",
        "text": "A field named gender that accepts male and female as values"
      }
    ],
    "correctAnswer": "C"
  },
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Yes, because Card2 cannot inherit from Card"
      },
      {
        "id": "B",
        "text": "Yes, because we cannot use 'self' keyword on an inherited variable"
      },
      {
        "id": "C",
        "text": "Yes, because __x is private"
      },
      {
        "id": "D",
        "text": "No"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "The Factory pattern uses the Singleton pattern while Abstract Factory does not"
      },
      {
        "id": "B",
        "text": "The Abstract Factory pattern produces objects of a product class while Factory Pattern provides interface to create a family of related objects"
      },
      {
        "id": "C",
        "text": "The Factory pattern produces objects of a product class while Abstract Factory Pattern provides interface to create a family of related objects"
      },
      {
        "id": "D",
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "To store the current page number and display it on the page"
      },
      {
        "id": "B",
        "text": "To store the page number and display on page when submit is pressed"
      },
      {
        "id": "C",
        "text": "To store the current page number and hide it from the page"
      },
      {
        "id": "D",
        "text": "To hide any occurances of the pagename element from all pages of our web site"
      }
    ],
    "correctAnswer": "C"
  },
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Write Code Once"
      },
      {
        "id": "B",
        "text": "Keep Architecture Components Balanced"
      },
      {
        "id": "C",
        "text": "Separate Concerns in Modules"
      },
      {
        "id": "D",
        "text": "Keep Unit Interfaces Small"
      }
    ],
    "correctAnswer": "C"
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "ALTER TABLE products DROP CONSTRAINT products_PK;"
      },
      {
        "id": "B",
        "text": "ALTER TABLE products UPDATE CONSTRAINT products_PK;"
      },
      {
        "id": "C",
        "text": "ALTER TABLE products DELETE CONSTRAINT products_PK;"
      },
      {
        "id": "D",
        "text": "ALTER TABLE products TRUNCATE CONSTRAINT products_PK;"
      }
    ],
    "correctAnswer": "A"
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Write Machine Code"
      },
      {
        "id": "B",
        "text": "Whole Method Complexity"
      },
      {
        "id": "C",
        "text": "Waste Method Concern"
      },
      {
        "id": "D",
        "text": "Weighted Methods per Class"
      }
    ],
    "correctAnswer": "D"
  },
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Nothing, the program will not terminate"
      },
      {
        "id": "B",
        "text": "BCCCCC"
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Create a purchase for a new client that is not contained in the table clients"
      },
      {
        "id": "B",
        "text": "Delete a client who has made a purchase from the table clients"
      },
      {
        "id": "C",
        "text": "Change the value of the primary key of table clients"
      },
      {
        "id": "D",
        "text": "Find the purchases that correspond to an existing client"
      }
    ],
    "correctAnswer": "D"
  },
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "self.assertEqual(square(-2), 4)"
      },
      {
        "id": "B",
        "text": "self.assertEqual(square(\"four\"), \"sixteen\")"
      },
      {
        "id": "C",
        "text": "self.assertEqual(square(25), 5)"
      },
      {
        "id": "D",
        "text": "assertsFunction(square)"
      }
    ],
    "correctAnswer": "A"
  },
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Test 1000 randomly chosen combinations of numbers within the range"
      },
      {
        "id": "B",
        "text": "Test 1000 randomly chosen combinations of integers"
      },
      {
        "id": "C",
        "text": "Test all combinations of all numbers within the range"
      },
      {
        "id": "D",
        "text": "Test all combinations of numbers at 0, -1, 1, 128, 254, 255, 256"
      }
    ],
    "correctAnswer": "D"
  },
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Line 15: There cannot be an <aside> element within an <article> element"
      },
      {
        "id": "B",
        "text": "Line 21-23: <a> elements should be within a <nav> element"
      },
      {
        "id": "C",
        "text": "Line 1: <nav> element should be within a <header> element"
      },
      {
        "id": "D",
        "text": "Line 10: <header> element is not necessary"
      }
    ],
    "correctAnswer": "D"
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "A two-way encryption process that uses the same key for both encryption and decryption of your message"
      },
      {
        "id": "B",
        "text": "An algorithm that takes an arbitrary block of data and returns a fixed-size string, the (cryptographic) hash value, such that any (accidental or intentional) change to the data will change the hash value"
      },
      {
        "id": "C",
        "text": "A common attack vector that uses malicious SQL code for backend database manipulation to access information that was not intended to be displayed"
      },
      {
        "id": "D",
        "text": "One of the least common web hacking techniques that uses HTML code"
      }
    ],
    "correctAnswer": "C"
  },
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "C",
        "text": "Y is not a copy of X"
      },
      {
        "id": "D",
        "text": "There is no relationship between the two objects"
      }
    ],
    "correctAnswer": "B"
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "A string representing the scheme of the request (http or https)"
      },
      {
        "id": "B",
        "text": "A string representing the full path to the requested page, not including the scheme or domain. Example: \"/articles/2000/\""
      },
      {
        "id": "C",
        "text": "The originating host of the request. Example: \"127.0.0.1:8000\""
      },
      {
        "id": "D",
        "text": "A string representing the full path to the requested page, including the scheme or domain. Example: \"http://localhost:8000/articles/2000/\""
      }
    ],
    "correctAnswer": "B"
  },
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "A tool to help understand a targeted persona."
      },
      {
        "id": "B",
        "text": "A tool to help understand programmers' needs."
      },
      {
        "id": "C",
        "text": "Can carry out new research to fill in gaps regarding user understanding."
      },
      {
        "id": "D",
        "text": "Acts as the centerpiece of a software-centered design process."
      }
    ],
    "correctAnswer": "D"
  },
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "book = Book.create(\"Pride and Prejudice\")"
      },
      {
        "id": "B",
        "text": "book = Book.objects.create_book(\"Pride and Prejudice\")"
      },
      {
        "id": "C",
        "text": "book = Book(\"Pride and Prejudice\")"
      },
      {
        "id": "D",
        "text": "book =Book.objects.get(\"Pride and Prejudice\")"
      }
    ],
    "correctAnswer": "A"
  },
  ...
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "code": "<body style=\"background-image:url('myimage.jpg')\">"
      },
      {
        "id": "B",
        "code": "<img src=\"https://www.afdemp.org/images/'myimage.jpg\" alt=\"afdemp.org\">"
      },
      {
        "id": "C",
        "code": "<a href=\"myimage.jpg\">"
      },
      {
        "id": "D",
        "code": "<img src=\"https://www.afdemp.org/images/logo.jpg\" alt=\"afdemp.org\">"
      }
    ],
    "correctAnswer": "A"
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "The primary key of table Instrucor will be used as foreign key in table Class"
      },
      {
        "id": "B",
        "text": "The primary key of table Class will be used as foreign key in table Instructor"
      },
      {
        "id": "C",
        "text": "An intermediate table needs to be created containing the primary keys of the two tables as foreign keys."
      },
      {
        "id": "D",
        "text": "There is no need to establish any kind of relationship between the two tables"
      }
    ],
    "correctAnswer": "B"
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "Identifies the primary key in a database table"
      },
      {
        "id": "B",
        "text": "Identifies the foreign key in a database table"
      },
      {
        "id": "C",
        "text": "Identifies the index in a database table"
      },
      {
        "id": "D",
        "text": "Uniquely identifies each record in a database table"
      }
    ],
    "correctAnswer": "A"
  },
  {
    ...
    "options": [
      {
        "id": "A",
        "text": "SELECT last_name, department_name \nFROM employees e LEFT OUTER \nJOIN departments d ON (e.department_id = d.department_id)"
      },
      {
        "id": "B",
